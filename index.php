...
<tr>
<td> &ensp;&ensp; Olá Usuario&ensp; <?php print"$usuario"; ?>
<td  width = "80%"> </td><table width = "100%" border = "1" cellspacing = "0" cellpadding = "0">
	<tr> 
		<td colspan="2"><!--<img src = "fd.gif"></td> (POR IMAGEM NO CABECALHO) -->
	</tr>
	<tr> 
		<td width=20%>		
		<table width = "100%" border = "1" cellspacing = "0" cellpadding = "0">
